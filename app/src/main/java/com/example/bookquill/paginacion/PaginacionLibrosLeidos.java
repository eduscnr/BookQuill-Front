...
public class PaginacionLibrosLeidos extends RxPagingSource<Integer, Libro> {
    private String token;
    private MutableLiveData<Integer> totalLibros;

    public PaginacionLibrosLeidos(String token) {
        this.token = token;
    ...
    public Single<LoadResult<Integer, Libro>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        ...
        return apiService.obtenerLibrosLeidos(pagina, MainActivity.getUsuarioDTO().getIdUsuario())
