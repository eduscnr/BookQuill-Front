...
public class PaginacionAllLibros extends RxPagingSource<Integer, Libro> {
    private String token;
    private MutableLiveData<Integer> totalLibros;

    public PaginacionAllLibros() {
    }

    public PaginacionAllLibros(String token) {
        this.token = token;
    ...
    public Single<LoadResult<Integer, Libro>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        ...
        return apiService.getLibros(pagina)
